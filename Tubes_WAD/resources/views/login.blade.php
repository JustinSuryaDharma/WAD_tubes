		...
		<!-- Start Hero Section -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4">
                    <div class="card bg-dark text-center p-5">
                        <form>
                            ...
                            <div class="text-center mt-4">
                                <a href="/index"><button class="btn btn-secondary btn-icon mb-3 mb-sm-0"
					...
					<div class="row pt-4">
						<div class="col-lg-6">
							<p class="mb-2 text-center text-lg-start">Copyright &copy;<script>document.write(new Date().getFullYear());</script>. All Rights Reserved. &mdash; Designed with love by <a href="">GreenGlow</a> Distributed By <a href="">GreenGlow</a>  </p>
						</div>
