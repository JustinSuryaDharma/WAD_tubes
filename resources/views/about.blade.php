			...
			<div class="row justify-content-between">
				<div class="col-lg-5">
					<div class="intro-excerpt">
						<h1>Who is GreenGlow?</h1>
						<p class="mb-4">Natural Soap Embracing Circular Economy Through Recycled Waste as a Distinctive Product from Rancakalong Village for a Sustainable Future</p>
						<p>
				...
				<div class="col-lg-7">
					<div class="hero-img-wrap">
						<img src="images/soap_png.png" class="img-fluid" style="width: 300px; max-width: 100%; margin: 0 auto;">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
					...
					<h3 clas><a href="#"><span class="">M.</span> Adam Zaidan</a></h3>
					<span class="d-block position mb-4">Project Manager</span>
					<p>WAD pelajaran paling seru semester ini!!!</p>
				...
				<div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
					...
					<h3 clas><a href="#"><span class="">Justin</span> Surya Dharma</a></h3>
					<span class="d-block position mb-4">Full Stack Developer</span>
					<p>Gatau kenapa tapi setiap tidur kok mimpinya tentang laravel ya</p>
					<p class="mb-0"><a href="#" class="more dark">Learn More <span class="icon-arrow_forward"></span></a></p>
				...
				<div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
					...
					<h3 clas><a href="#"><span class="">Dhewa</span> Radya</a></h3>
					<span class="d-block position mb-4">Quality Assurance Tester</span>
					<p>Ngoding, Turu, Ngoding, Turu, Repeat.</p>
					<p class="mb-0"><a href="#" class="more dark">Learn More <span class="icon-arrow_forward"></span></a></p>
				</div>
				<!-- End Column 3 -->
				...
				<div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
					...
					<h3 clas><a href="#"><span class="">Rafi</span> Abdul Fatah</a></h3>
					<span class="d-block position mb-4">Operational Officer</span>
					<p>Hobi gue adalah motoran sambil ndengerin visual studio code</p>
					<p class="mb-0"><a href="#" class="more dark">Learn More <span class="icon-arrow_forward"></span></a></p>
